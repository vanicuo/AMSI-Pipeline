function [bestmatch, GOF_of_bestmatch, fit_residuals, GOF_scores, dipole_amplitudes, best_match_topography] = CMR_dipfit(data_vector, lead_field, is_free_dipoles)
